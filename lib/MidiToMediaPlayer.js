...
class AudioContextClock {
    constructor(audioContextTime, localStartTime, debug = false) {
...
class MidiToMediaPlayer extends events_1.EventEmitter {
    ...
    scheduleAllNoteEvents(localStartTime, scheduleOptions, cb) {
        ...
        this.log(`WwMusic: MidiToMediaPlayer: target local start time: ${localStartTime}`);
        this.log(`WwMusic: MidiToMediaPlayer: calculated audioContext start time: ${this._acClock.calculatedAcStartTime}`);
